                        ...
                        if(item.type==1||item.type==3) {
                            ...
                            this.$http.post(table+'/update', this.user).then(res => {
                                ...
                                this.$http.post(`orders/update`, item).then(res => {
                                    if(item.tablename == `gouwushangcheng`){
                                        // 加回库存数量
                                        good.alllimittimes = good.alllimittimes + item.buynumber;
                                        this.$http.post(`gouwushangcheng/update`, good).then(res => {
                                        });
                                    }
                                    if(item.tablename == `cuxiaohuodong`){
                                        // 加回库存数量
                                        good.alllimittimes = good.alllimittimes + item.buynumber;
                                        this.$http.post(`cuxiaohuodong/update`, good).then(res => {
                                        });
                                    }
                                    this.$message({

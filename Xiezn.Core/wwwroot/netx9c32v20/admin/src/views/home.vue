...
<div class="content" :style='{"minHeight":"100vh","padding":"30px","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20240220/927b2d08dcdb48b3af07cef8d1a59f59.png) no-repeat center top / cover","display":"flex","width":"100%"}'>
	...
	<!-- 日历 -->
	<div class="calendar" :style='{"border":"1px solid rgb(240, 240, 240)","margin":"20px auto","borderRadius":"5px","background":"#fff","width":"100%","height":"auth","order":"50"}'>
	  <div :style='{"padding":"20px","borderColor":"#000","flexWrap":"wrap","borderWidth":"0 0 1px 0","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"space-between","height":"auto"}'>
	    <div @click="pyear" :style='{"cursor":"pointer","padding":"0 12px","alignItems":"center","color":"#fff","borderRadius":"4px","background":"#6aab9c","display":"flex","width":"auto","fontSize":"14px","justifyContent":"center","height":"40px"}'><span class="icon iconfont icon-fanhui" :style='{"color":"#fff","margin":"0 2px","fontSize":"16px"}'></span>上一年</div>
	    <div @click="pmonth" :style='{"cursor":"pointer","padding":"0 12px","alignItems":"center","color":"#fff","borderRadius":"4px","background":"#6aab9c","display":"flex","width":"auto","fontSize":"14px","justifyContent":"center","height":"40px"}'><span class="icon iconfont icon-fanhui" :style='{"color":"#fff","margin":"0 2px","fontSize":"16px"}'></span>上一月</div>
	    <div :style='{"padding":"0 10px","alignItems":"center","justifyContent":"center","display":"flex"}'>
	      <div :style='{"margin":"0 2px","fontSize":"24px","color":"#000","fontWeight":"600"}'>{{this.year}}年</div>
	      <div :style='{"margin":"0 2px","fontSize":"24px","color":"#000","fontWeight":"600"}'>{{this.month}}月</div>
	    </div>
	    <div @click="nmonth" :style='{"cursor":"pointer","padding":"0 12px","alignItems":"center","color":"#fff","borderRadius":"4px","background":"#6aab9c","display":"flex","width":"auto","fontSize":"14px","justifyContent":"center","height":"40px"}'>下一月<span class="icon iconfont icon-jinru" :style='{"color":"#fff","margin":"0 2px","fontSize":"16px"}'></span></div>
	    <div @click="nyear" :style='{"cursor":"pointer","padding":"0 12px","alignItems":"center","color":"#fff","borderRadius":"4px","background":"#6aab9c","display":"flex","width":"auto","fontSize":"14px","justifyContent":"center","height":"40px"}'>下一年<span class="icon iconfont icon-jinru" :style='{"color":"#fff","margin":"0 2px","fontSize":"16px"}'></span></div>
	  </div>

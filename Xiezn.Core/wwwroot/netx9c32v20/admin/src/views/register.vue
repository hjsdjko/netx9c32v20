	...
	<div>
		<div class="container" :style='{"minHeight":"auto","padding":"20px  20px 20px 400px","background-attachment":"fixed","background":"url(http://codegen.caihongy.cn/20240220/b7c1c0cd08d847ecb5e7145e3cdc43ae.jpg) no-repeat  center top / cover,#f9fbfd","display":"flex","width":"100%","justifyContent":"center"}'>
			<el-form v-if="pageFlag=='register'" :style='{"padding":"40px 20px","margin":"0","borderRadius":"10px","flexWrap":"wrap","background":"rgba(106, 171, 156)","display":"flex","width":"450px"}' ref="rgsForm" class="rgs-form" :model="rgsForm" :rules="rules">
				<div v-if="true" :style='{"width":"100%","margin":"0 auto 20px auto","lineHeight":"44px","fontSize":"20px","color":"#fff","textAlign":"center"}' class="title">基于Asp.net的客多多零食购物网站的设计与实现注册</div>
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 2px","height":"auto"}' class="list-item" v-if="tableName=='yonghu'">
					<div v-if="true" :style='{"width":"100%","lineHeight":"44px","fontSize":"14px","position":"relative","color":"#fff"}' class="lable" :class="changeRules('yonghudianhua')?'required':''">用户电话：</div>
